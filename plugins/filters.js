...
Sana.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if (!!message.mention && message.mention[0] == '918137975623@s.whatsapp.net') {
...
await message.client.sendMessage(message.jid, fs.readFileSync('./sana-media/bgm/mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, quoted : message.data, ptt: true})
        ...
        if (!!message.mention && message.mention[0] == 'Panda') {
await message.client.sendMessage(message.jid, fs.readFileSync('./sana-media/bgm/mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, quoted : message.data, ptt: true})
        }
...
Sana.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
    ...
    let banned = jid.find( Jid => Jid === message.jid);
    if(banned !== undefined) return
    if (!!message.mention && message.mention[0] == '@s.whatsapp.net') {
